...
<span data-lang="en">
As an HR manager,
I want to be able to view a weekly report of hours worked by each employee,
So that I can verify schedule compliance and prepare payroll.
</span>

<span data-lang="fr">
En tant que gestionnaire RH,
Je veux pouvoir consulter un rapport hebdomadaire des heures travaillées par chaque employé,
Afin de vérifier la conformité des horaires et préparer la paie.
</span>
